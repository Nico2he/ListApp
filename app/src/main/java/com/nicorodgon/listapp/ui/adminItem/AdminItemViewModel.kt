...
class AdminItemViewModel(lista: Lista): ViewModel() {
...
class AdminItemViewModelFactory(private val lista: Lista): ViewModelProvider.Factory{
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return AdminItemViewModel(lista) as T
    }
}